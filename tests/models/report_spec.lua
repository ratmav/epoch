-- tests/models/report_spec.lua

local report_model = require('models.report')

describe("models report", function()
  describe("create", function()
    it("should create a new empty report", function()
      local report_obj = report_model.create()
  ...
  describe("add_timesheet", function()
    it("should add timesheet to report", function()
      ...
      report_model.add_timesheet(report_obj, timesheet_obj)
    ...
    it("should update date range when adding timesheets", function()
      ...
      report_model.add_timesheet(report_obj, timesheets[1])  -- 2025-04-28
      report_model.add_timesheet(report_obj, timesheets[3])  -- 2025-05-05
  ...
  describe("calculate_summary", function()
    it("should aggregate intervals by client/project/task", function()
      ...
      for _, timesheet in ipairs(timesheets) do
        report_model.add_timesheet(report_obj, timesheet)
      end
      report_model.calculate_summary(report_obj)
  ...
  describe("get_timesheets_by_date_range", function()
    it("should return timesheets within date range", function()
      ...
      local filtered = report_model.get_timesheets_by_date_range(report_obj, "2025-04-28", "2025-04-30")
    ...
    it("should return all timesheets when no date range specified", function()
      ...
      local all_timesheets = report_model.get_timesheets_by_date_range(report_obj)
  ...
  describe("calculate_total_minutes", function()
    it("should sum minutes from all completed intervals", function()
      ...
      local total = report_model.calculate_total_minutes(report_obj)
    ...
    it("should ignore incomplete intervals", function()
      ...
      report_model.add_timesheet(report_obj, timesheet_complete)
      report_model.add_timesheet(report_obj, timesheet_with_open)
  ...
  describe("group_by_week", function()
    it("should group timesheets by week number", function()
      ...
      report_model.group_by_week(report_obj)
  ...
  describe("validate", function()
    it("should validate well-formed report", function()
      ...
      local is_valid, error_msg = report_model.validate(report_obj)
    ...
    it("should validate empty report", function()
      ...
      local is_valid, error_msg = report_model.validate(empty_report)
    ...
    it("should reject report missing required fields", function()
      ...
      local is_valid, error_msg = report_model.validate(invalid_report)
