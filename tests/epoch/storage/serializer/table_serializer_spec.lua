  ...
  describe("serialize_regular_keys", function()
    it("serializes table keys in sorted order", function()
      ...
      local output = table_serializer.serialize_regular_keys(
        fixtures.get('storage.tables.sorted_keys'), spaces, result, indent)
    ...
    it("handles numeric keys", function()
      ...
      local output = table_serializer.serialize_regular_keys(
        fixtures.get('storage.tables.numeric_keys'), spaces, result, indent)
    ...
    it("handles string keys", function()
      ...
      local output = table_serializer.serialize_regular_keys(
        fixtures.get('storage.tables.mixed_keys'), spaces, result, indent)
    ...
    it("handles numeric keys only", function()
      ...
      local output = table_serializer.serialize_regular_keys(
        fixtures.get('storage.tables.numeric_keys_only'), spaces, result, indent)
